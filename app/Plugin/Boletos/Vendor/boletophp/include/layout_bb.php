		...
		<div id="container">
			...
			<div id="boleto">
				...
				<table cellspacing=0 cellpadding=0 width=666 border=0>
					<tr>
						<td width=666 align=right ><span style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</span></td>
					</tr>
				</table>
				<div class="barcode">
				...
				<div class="cut">
					<p><?php echo $dadosboleto["codigo_barras"]; ?></p>
				</div>
