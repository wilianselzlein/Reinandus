 ...
 */
	public function index() {
		...
		$this->Filter->setPaginate('fields', array('Detalhe.id', 'Detalhe.aluno_id', 'Detalhe.foto', 'Detalhe.ocorrencias', 'Detalhe.hist_escolar', 'Detalhe.neg_financeira', 'Detalhe.egresso', 'Detalhe.imagem', 'Aluno.id', 'Aluno.nome'));
 ...
 */
	public function view($id = null) {
		...
		$options = array('recursive' => false, 'conditions' => array('Detalhe.' . $this->Detalhe->primaryKey => $id), 
			'fields' => array('Detalhe.id', 'Detalhe.aluno_id', 'Detalhe.foto', 'Detalhe.ocorrencias', 'Detalhe.hist_escolar', 'Detalhe.neg_financeira', 'Detalhe.egresso', 'Detalhe.imagem', 'Aluno.id', 'Aluno.nome'));
