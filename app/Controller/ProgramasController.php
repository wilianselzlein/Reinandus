 ...
 */
 private function AdicionarProgramasSeNecessario() {
    ...
    $this->AdicionarProgramaSeNaoExistir( 6, 'Pessoa');
 	...
 	/*
 	$this->AdicionarProgramaSeNaoExistir(33, '');
 	$this->AdicionarProgramaSeNaoExistir(34, '');
 	$this->AdicionarProgramaSeNaoExistir(35, '');
 	$this->AdicionarProgramaSeNaoExistir(36, '');
 	$this->AdicionarProgramaSeNaoExistir(37, '');
