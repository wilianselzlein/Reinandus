 ...
 */
	public function view($id = null) {
		...
		$options = array('recursive' => false, 'conditions' => array('Aluno.cidade_id' => $id), 'limit' => $this->LimiteView(),
		...
		$options = array('recursive' => false, 'conditions' => array('Pessoa.cidade_id' => $id), 
		...
		$options = array('conditions' => array('Professor.cidade_id' => $id),
		  'fields' => array('Professor.id', 'Professor.nome', 'Professor.celular', 'Professor.email', 'Cidade.id', 'Cidade.nome'));
		$this->Cidade->Professor->unbindModel(array('hasAndBelongsToMany' => array('Disciplina'), 'hasMany' => array('Aluno', 'AlunoDisciplina', 'Curso', 'CursoDisciplina', 'ProfessorDisciplina', 'ContaPagar')));
