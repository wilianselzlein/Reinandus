 ...
 * @var array
 */
	public $components = array('Paginator', 'Session', 'Boletos.BoletoBb', 'Boletos.BoletoHsbc', 'Boletos.BoletoBradesco', 'Boletos.BoletoItau', 'TransformarArray');
 ...
 */
	public function index($tipo = null) {
		...
		$this->Filter->setPaginate('fields', array('Mensalidade.id', 'Mensalidade.numero', 'Aluno.id', 'Aluno.nome', 'Mensalidade.vencimento', 'Mensalidade.liquido', 'Mensalidade.pagamento', 'Mensalidade.pago',
...
//debug($mensalidade); debug($lancamento); die;
