 ...
 *
 */
	Configure::write('Routing.prefixes', array('aluno'));
 ...
 *
 */
	Configure::write('Session', array('defaults' => 'cache'));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi_reinandus');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453496836451234567890');
