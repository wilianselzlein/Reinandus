	 <div class="panel panel-default ">
            ...
            <h2><?php echo __('Grupo'); ?>                <small><?php echo __('View'); ?></small>
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">		
								<li><?php echo $this->Html->link('<i class="fa fa-pencil"></i>'.' '.__('Edit').' '.__('Grupo'), array('action' => 'edit', $grupo['Grupo']['id']), array('class' => '','escape'=>false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<i class="fa fa-times"></i>'.' '.'Delete').' '.__('Grupo'), array('action' => 'delete', $grupo['Grupo']['id']), array('class' => '','escape'=>false), __('Are you sure you want to delete # %s?', $grupo['Grupo']['id'])); ?> </li>
		<li><?php echo $this->Html->link('<i class="fa fa-list-alt"></i>'.' '.__('List').' '.__('Grupos'), array('action' => 'index'), array('class' => '','escape'=>false)); ?> </li>
		<li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>'.' '.__('New').' '.__('Grupo'), array('action' => 'add'), array('class' => '','escape'=>false)); ?> </li>
		...
		<th><?php echo __('Tipo'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($grupo['Aviso'] as $aviso): ?>
		<tr>
			<td><?php echo $aviso['Data']; ?></td>
			<td><?php echo $aviso['username']; ?></td>
			<td><?php echo $aviso['arquivo']; ?></td>
			<td><?php echo $aviso['mensagem']; ?></td>
			<td><?php echo $aviso['nome']; ?></td>
			<td class="actions text-center">
				<?php echo $this->Html->link('<i class="fa fa-eye"></i>', array('controller' => 'alunos', 'action' => 'view', $aviso['id']), array('class' => 'btn btn-default btn-xs','escape'=>false, 'title'=>__('View'), 'data-toggle'=>'tooltip')); ?>
				<?php echo $this->Html->link('<i class="fa fa-pencil"></i>', array('controller' => 'alunos', 'action' => 'edit', $aviso['id']), array('class' => 'btn btn-default btn-xs','escape'=>false, 'title'=>__('Edit'), 'data-toggle'=>'tooltip')); ?>
				<?php echo $this->Form->postLink('<i class="fa fa-times"></i>', array('controller' => 'alunos', 'action' => 'delete', $aviso['id']), array('class' => 'btn btn-default btn-xs','escape'=>false, 'title'=>__('Delete'), 'data-toggle'=>'tooltip'), __('Are you sure you want to delete # %s?', $aviso['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
							</tbody>
