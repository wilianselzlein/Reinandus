...
<div class="panel-heading">
            <h3><?php echo __('Grupo'); ?>                    <small><?php echo __('Edit') ?></small>
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                    				<li><?php echo $this->Form->postLink('<i class="fa fa-times"></i>'.' '.__('Delete'), array('action' => 'delete', $this->Form->value('Grupo.id')), array('escape'=>false), __('Are you sure you want to delete # %s?', $this->Form->value('Grupo.id'))); ?></li>
	...
	<div class="panel-body">
		...
		<div class="grupos form">
			...
			<?php echo $this->Form->create('Grupo', array('role' => 'form', 'class'=>'form-horizontal')); ?>
