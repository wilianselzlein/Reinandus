<div class="panel panel-default">
	<div class="panel-heading">
		<h3><?php echo __('Monitoramento');?>
        	<small><?php echo __('de problemas encontrados') ?></small>
        </h3>
    </div>
	<div class="panel-body">
	<ul class="list-group">
	<?php foreach ($resumos as $resumo => $conta): ?>
		<?php if ($conta > 0 ) { ?>
			...
			<?php echo $this->Form->create('Monitoramento', array('role' => 'form', 'class'=>'form-horizontal', 'action' => 'consultar')); ?>
				<fieldset>
					...
					<?php echo $this->Ajax->submit('Consultar', array(
						...
						'url'=> array('controller'=>'Monitoramentos', 'action'=>'consultar'), 
						'update' => 'Consulta',
