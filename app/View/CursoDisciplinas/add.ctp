...
<div class="panel-heading">
            <h3><?php echo __('Disciplina'); ?>
				...
				<li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>'.' '.__('New').' '.__('Disciplina'), array('controller' => 'disciplinas', 'action' => 'add'),array('escape'=>false)); ?> </li>
				<li><?php echo $this->Html->link('<i class="fa fa-list-alt"></i>'.' '.__('List').' '.__('Professores'), array('controller' => 'professors', 'action' => 'index'),array('escape'=>false)); ?> </li>
