            ...
            <h2><?php echo __('Professor'); ?>                <small><?php echo __('View'); ?></small>
                ...
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">		
								<li><?php echo $this->Html->link('<i class="fa fa-pencil"></i>'.' '.__('Edit').' '.__('Professor'), array('action' => 'edit', $professor['Professor']['id']), array('class' => '','escape'=>false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<i class="fa fa-times"></i>'.' '.'Delete').' '.__('Professor'), array('action' => 'delete', $professor['Professor']['id']), array('class' => '','escape'=>false), __('Are you sure you want to delete # %s?', $professor['Professor']['id'])); ?> </li>
		<li><?php echo $this->Html->link('<i class="fa fa-list-alt"></i>'.' '.__('List').' '.__('Professors'), array('action' => 'index'), array('class' => '','escape'=>false)); ?> </li>
		<li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>'.' '.__('New').' '.__('Professor'), array('action' => 'add'), array('class' => '','escape'=>false)); ?> </li>
