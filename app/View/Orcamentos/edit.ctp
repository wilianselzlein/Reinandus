...
<?php echo $this->ButtonsActions->MakeButtons($this->params['controller'], $this->params['action'], $this->params['pass'][0]); ?>
   ...
   <div class="panel-body">
      ...
      <div class="orcamento form">
         ...
         <?php echo $this->Form->create('Orcamento', array('role' => 'form', 'class'=>'form-horizontal')); ?>
         ...
         <fieldset>
            ...
            <div class="form-group">
               <?php echo $this->Form->input('data',
                                             array('type' => 'text', 'autofocus' => 'autofocus', 'class' => 'form-control datepicker-start', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>false, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
                                            ); ?>
            </div><!-- .form-group -->
            <div class="form-group">
               <?php echo $this->Form->input('plano_conta_id',
                                             array('options' => $plano_conta, 'class' => 'form-control combobox', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>false, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
                                            ); ?>
            </div><!-- .form-group -->
            <div class="form-group">
