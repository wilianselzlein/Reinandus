		...
		<div class="relatoriofiltros form">
			...
			<?php echo $this->Form->create('RelatorioFiltro', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('campo', array('class' => 'form-control', 'autofocus' => 'autofocus', 'between' => ' <i>alias  _  campo</i>')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						<?php echo $this->Form->input('is_obrigatorio', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
