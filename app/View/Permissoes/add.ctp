...
<div class="panel-heading">
            <h3><?php echo __('Permissao'); ?><small><?php echo __('Add') ?></small>
	...
	<div class="panel-body">
		...
		<div class="permissaos form">
			...
			<?php echo $this->Form->create('Permissao', array('role' => 'form', 'class'=>'form-horizontal')); ?>
				...
				array('type' => 'checkbox', 'class' => 'form-control', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>false, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
				); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('view', 
				array('type' => 'checkbox', 'class' => 'form-control', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>false, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
				); ?>
					</div><!-- .form-group -->
					<div class="form-group">
