	...
	<div class="panel-body">
		...
		<div class="disciplinas form">
			...
			<?php echo $this->Form->create('AlunoDisciplina', array('role' => 'form', 'class'=>'form-horizontal')); ?>
				...
				array('min'=> '0', 'max'=> '100', 'step' => '1', 'class' => 'form-control', 'autofocus' => 'autofocus', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>true, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
				); ?>
					</div><!-- .form-group -->
					<div class="form-group">
				...
				array('class' => 'form-control', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>true, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
					...
					<div class="form-group">
						...
						$data = $data['AlunoDisciplina']['data'];
						if ($data == '')
							$data = date('d/m/Y');
						echo $this->Form->input('data',
				array('type' => 'text', 'value' => $data, 'class' => 'form-control datepicker-start', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>true, 'between'=>'<div class="col-sm-10">', 'after'=>'</div>')
				); ?>
					</div><!-- .form-group -->
