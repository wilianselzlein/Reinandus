	...
	<div class="panel-body">
		...
		<div class="cursos form">
			...
			<?php echo $this->Form->create('Curso', array('role' => 'form', 'class'=>'form-horizontal')); ?>
				...
				array('class' => 'form-control', 'label'=>array('class'=>'col-sm-2 control-label'), 'div'=>false, 'between'=>'<div class="col-sm-10"><div class="input-group"><span class="input-group-addon">R$</span>', 'after'=>'</div></div>')
				); ?>
					</div><!-- .form-group -->
					<div class="form-group">
