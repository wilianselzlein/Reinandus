...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed" style="
	...
	<tr  class="active">
		...
		<th width="7%">			
			<?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>', array('controller' => 'curso_disciplinas', 'action' => 'add', $curso_id), array('class' => 'btn btn-default btn-xs','escape'=>false, 'title'=>__('Add') . __('Disciplina'), 'data-toggle'=>'tooltip')); ?>
		</th>
	</tr>
