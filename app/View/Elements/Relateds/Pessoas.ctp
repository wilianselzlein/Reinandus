<?php if (! $this->PermissaoRelated->Verificar(6)) return; ?>
<?php if (!isset($id)) $id = 'divPessoas'; ?>
    ...
    <h3><?php echo __('Pessoas').' ' ?> 
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>'.' '.__('New').' '.__('Pessoa'), array('controller' => 'pessoas', 'action' => 'add'), array('class' => '', 'escape' => false)); ?>
                </li>
            </ul>   
        </div>
    </h3>
...
<tr>
	...
	<td><?php echo $this->DisplayField->MakeLink($pessoa, 'cidades', 'cidade_id'); ?></td>
