...
?>
     ...
     <?php /*echo $this->Form->input('simplificado',
...
<?php echo $this->Form->input('pagamento',
     array('type' => 'text', 'class' => 'form-control datepicker-start', 'label'=>array('class'=>'col-sm-1 control-label cad-simplificado <?php echo $classe; ?>', 'style' => 'padding-left: 0px;'), 'div'=>true, 'between'=>'<div class="col-sm-4 cad-simplificado <?php echo $classe; ?>">', 'after'=>'</div>')); ?>
</div><!-- .form-group -->
<div class="form-group">
...
<?php echo $this->Form->input('desconto',
     array('class' => 'form-control ', 'label'=>array('class'=>'cad-simplificado <?php echo $classe; ?> col-sm-1 control-label', 'style' => 'padding-left: 0px;'), 'div'=>false, 'wrap'=>false,'between'=>'<div class="col-sm-4 cad-simplificado <?php echo $classe; ?>"><div class="col-sm-10"><div class="input-group"><span class="input-group-addon">R$</span>', 'after'=>'</div></div></div>')); ?>
</div><!-- .form-group -->
<div class="form-group cad-simplificado <?php echo $classe; ?>">
...
<?php echo $this->Form->input('saldo',
     array('class' => 'form-control ', 'label'=>array('class'=>'cad-simplificado <?php echo $classe; ?> col-sm-2 control-label', 'style' => 'padding-left: 0px;'), 'div'=>false, 'wrap'=>false,'between'=>'<div class="col-sm-4 cad-simplificado <?php echo $classe; ?>"><div class="col-sm-10"><div class="input-group"><span class="input-group-addon">R$</span>', 'after'=>'</div></div></div>')); ?>
</div><!-- .form-group -->
<div class="form-group cad-simplificado <?php echo $classe; ?>">
