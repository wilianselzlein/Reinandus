...
<div class="panel-heading">
            <h3><?php echo __('Grupo'); ?>
				...
				<li><?php echo $this->Html->link('<i class="fa fa-list-alt"></i>'.' '.__('List').' '.__('Grupos'), array('controller' => 'grupos', 'action' => 'index'),array('escape'=>false)); ?> </li>
				<li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>'.' '.__('New').' '.__('Grupo'), array('controller' => 'grupos', 'action' => 'add'),array('escape'=>false)); ?> </li>
	...
	<div class="panel-body">
		...
		<div class="grupos form">
			...
			<?php echo $this->Form->create('AvisoGrupo', array('role' => 'form', 'class'=>'form-horizontal')); ?>
