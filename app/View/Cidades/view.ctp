...
<?php echo $this->element('ViewRelatedsAlunos', array('array' => $cidade)); ?>
<?php echo $this->element('ViewRelatedsPessoas', array('array' => $cidade)); ?>
<?php echo $this->element('ViewRelatedsProfessores', array('array' => $cidade)); ?>
